...
class PreInteCostFunction : public ceres::SizedCostFunction</*residual*/ 9, /*a*/ 7, /*b*/ 3, /*c*/ 3, /*d*/ 3, /*e*/ 7,
   ...
   public:
    ...
    PreInteCostFunction(std::shared_ptr<IMUPreintegration> preinteg, const Vec3d &gravity, double weight)
        : preint_(preinteg), grav_(gravity), dt_(preinteg->dt_) {
        sqrt_information_ =
    ...
    virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const {
        ...
        const Vec3d ep = RiT_Mat * (p_j - p_i - v_i * dt_ - grav_ * dt_ * dt_ * 0.5) - dp;
        ...
        if (jacobians[0]) {
            ...
            // dp/dR1.
            jacobian_pose_i.block<3, 3>(6, 3) = SO3::hat(RiT * (p_j - p_i - v_i * dt_ - 0.5 * grav_ * dt_ * dt_));
            // dp/dp1.
...
*/
class PreInteCostFunctionSep : public ceres::SizedCostFunction<9, /*a*/3, /*b*/4, /*c*/3, /*d*/3, /*e*/3, /*f*/3, /*g*/4, /*h*/3> {
  public:
    ...
    virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const {
            ...
            if (jacobians[1]) {
                ...
                // dp/dR1.
                jacobian_R_i.block<3, 3>(6, 0) = SO3::hat(RiT * (p_j - p_i - v_i * dt_ - 0.5 * grav_ * dt_ * dt_));
